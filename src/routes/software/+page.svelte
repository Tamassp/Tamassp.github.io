			...
			projects={[
				{
					...
					demoSrc: bprDemo,
					filterTag: 'frontend',	
					gitHubLink: 'https://github.com/Bachelor-Project-Keyhole/ReactWebApp',				
					icons: ['react', 'ts', 'js', 'c#'],
					projectColor: '#663399',
				...
				},
				{
					...
					filterTag: 'frontend',
					gitHubLink: 'https://github.com/SEP6-MOVIEAPP/MovieApplication',
				...
				},
				{
					...
					demoSrc: androidDemo,
					filterTag: 'frontend',
					gitHubLink: 'https://github.com/GreenHouseSEP4/AndroidClient',
			...
			projects={[
				{
					...
					filterTag: 'frontend',
					gitHubLink: 'https://github.com/Tamassp/Tamassp.github.io',
					icons: ['svelte', 'ts', 'js'],
					inProgress: true,
					projectColor: '#176178',
