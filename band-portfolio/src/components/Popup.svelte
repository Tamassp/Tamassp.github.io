...
{#if show}
	...
	<div class="fixed inset-0 flex items-center justify-center z-40 //blur-sm backdrop-blur-md">
		<div
			class="relative bg-background opacity-90 text-white shadow-lg //border-[1px] border-t-4 
      h-full md:h-auto max-h-[90vh] min-w-[256px] m-2 mt-8 z-50 "
		>
			...
			<!-- <p>{content}</p> -->
			<button
				class="absolute p-4 right-1 top-1 bg-transparent text-white hover:bg-slate-400"
				on:click={closePopup}
			>
				X
			</button>
