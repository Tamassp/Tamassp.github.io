...
<section class="min-h-screen full-screen-section bg-green-300 flex flex-col justify-center">
        ...
        <!-- <div transition:fade={{delay: 0, duration: 600}}> -->
            <svg id="travelSign" xmlns="http://www.w3.org/2000/svg" width="320" height="256" viewBox="0 0 64 64" fill="none"
            class="ml-[calc(20%-144px)] mt-32">
                <path transition:draw={{  delay: 300, duration: 600, }}
                 d="M28 32V56" stroke="black" stroke-width="0.5"/>
                <path transition:draw={{  delay: 0, duration: 600, }}
                 d="M2 32V8H48L62 20L48 32Z" stroke="black" stroke-width="0.5"/>
        ...
        <div use:viewport 
            ...
            >
        {#if innerWidth > 1024}
        <svg class="ml-[20vw]" width="60%" height="h-auto" viewBox="0 0 690 408" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {:else}
        <svg id="transitionSVG3" class=" ml-[20vw]" width="60%" height="h-auto" viewBox="0 0 345 408" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,0 Q25,150 172,204 T345,408"  
                stroke="white" stroke-width="5" stroke-linejoin="round" stroke-linecap="round">
            </path>
            <path  d="M0,0 Q25,150 172,204 T345,408" 
            stroke="#C0D1EB" stroke-width="5" stroke-linejoin="round" stroke-linecap="round" stroke-dasharray="20 20">
            </path>
            <path id="dashline3" d="M345,408Q370,208 172,204Q25,150 0,0" stroke="white" stroke-width="5" stroke-linejoin="round" 
            stroke-linecap="round" pathLength="1" stroke-dashoffset="0px" stroke-dasharray="0.2941537710336538px 1px">
            </path>
        </svg>
        {/if}
    ...
    <section class="/*full-screen-section full-width-section p-1 /*flex /*flex-col justify-center">
        ...
        <div class="relative grid /*md:gap-16 lg:grid-cols-2 w-full">
           <div class="order-2 lg:order-1 flex flex-row lg:justify-end">
            <Description class=" text-justify align-middle  col-span-1 mt-4 lg:mt-16 bg-gradient-to-r from-90% from-white to-100% pr-8 z-20">
                We were introduced to C++ first, where I could learn the basics
            ...
            <div class="flex flex-row justify-end lg:relative lg:justify-normal order-1 lg:order-2 col-span-1 ">
                <img src="src/images/gimi.png" alt="gimi" class="w-[70%] mr-0 h-auto lg:w-auto min-h-full object-fit z-10 " />
            </div>
        </div>
    </section>
     <section class="/*min-h-screen /*full-screen-section bg-green-300 flex flex-col justify-center">
        ...
        <div use:viewport 
            ...
            >
        <svg id="transitionSVG2" class=" ml-[20vw]" width="60%" height="h-auto" viewBox="0 0 690 408" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,0 Q50,200 345,204 T690,408" 
                stroke="white" stroke-width="5" stroke-linejoin="round" stroke-linecap="round">
            </path>
            <path  d="M0,0 Q50,200 345,204 T690,408" 
            ...
            <path id="dashline2" d="M690,408Q640,208 345,204Q50,200 0,0" stroke="white" stroke-width="5" stroke-linejoin="round" 
            stroke-linecap="round" pathLength="1" stroke-dashoffset="0px" stroke-dasharray="0.2941537710336538px 1px">
            </path>
        </svg>
    </section>
    <section class="/*full-screen-section p-1 flex flex-col justify-center">
        ...
        <div class="grid md:gap-16 md:grid-cols-2">
            ...
            <Description class="flex drop-shadow-[0_2px_1px_rgba(0,0,0,0.3)] mt-16">We were introduced to C++ first, where I could learn the basics
                of programming and I could practice creating algorithms. Througout my
                studies I've participated in extra courses in software developement
                where we were creating apps in HTML/CSS, Java and Android studio In the last
                year we were working with C#
